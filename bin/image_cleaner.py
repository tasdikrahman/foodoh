...
#### Status : 
'''
Running successfully on the "test_images". 
TO modify it and run it on "images" directory
'''
...
def main() : 
	...
	images_dir = r'/home/tasdik/Dropbox/projects/big_data_project/test/images'

	## get the list of directories (the hotels) and store it in a list 
	hotels_list = os.listdir('/home/tasdik/Dropbox/projects/big_data_project/test/images')

	## creating the cleaned menu dir if it not exists
	cleaned_images_dir = r'/home/tasdik/Dropbox/projects/big_data_project/test/cleaned_images'
