...
def main() : 
	...
	dark_file = '/home/tasdik/Dropbox/projects/big_data_project/test/dark_ocr_menu_output'
	dest_file = '/home/tasdik/Dropbox/projects/big_data_project/test/all_menu_dark'

	if not os.path.exists(dest_file) : 
		os.makedirs(dest_file)

	hotels_list = os.listdir('/home/tasdik/Dropbox/projects/big_data_project/test/dark_ocr_menu_output')
