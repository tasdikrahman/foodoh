...
#### Status : 
'''
Running successfully on the "images" directory
All images cleaned and stored in "cleaned_images" directory
'''
...
def main() : 
	...
	images_dir = r'/home/tasdik/Dropbox/projects/big_data_project/test/light_background'

	## get the list of directories (the hotels) and store it in a list 
	hotels_list = os.listdir('/home/tasdik/Dropbox/projects/big_data_project/test/light_background')
